// // client/src/app/(dashboard)/student-dashboard/components/mail/TypeTabs.tsx
// "use client"
...
//               onClick={() => setType(t)}
//               className={[
//                 "h-7 px-2.5 rounded-md text-[11px] font-semibold transition",
...
//           className="h-9 pl-3 pr-6 rounded-md text-[11px] font-semibold border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 cursor-pointer appearance-none"
//         >
